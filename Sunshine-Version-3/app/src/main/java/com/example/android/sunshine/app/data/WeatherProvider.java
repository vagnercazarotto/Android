...
public class WeatherProvider extends ContentProvider {
    ...
    /*
        ...
        testUriMatcher test within TestUriMatcher. You can test this by uncommenting the
     */
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            ...
            case WEATHER_WITH_LOCATION_AND_DATE:
                return WeatherContract.WeatherEntry.CONTENT_ITEM_TYPE; // only return one type

            case WEATHER_WITH_LOCATION:
                return WeatherContract.WeatherEntry.CONTENT_TYPE; // return more than one type
        ...
        switch (match) {
            ...
            case LOCATION:{
                ...
                if(_id > 0)
                    ...
                    throw new android.database.SQLException("Failed to inset into" + uri);
                break;
            }
